...
class DoctorPatientListSerializer(serializers.ModelSerializer):
    ...
    def get_last_appointment(self, obj):
        if hasattr(obj, 'last_apt_date') and obj.last_apt_date:
            return {
                'date': obj.last_apt_date,
                'time': obj.last_apt_time
            }
        return None
    
    def get_total_appointments(self, obj):
        return getattr(obj, 'total_apts', 0)
    
    def get_prescription_count(self, obj):
        return getattr(obj, 'pres_count', 0)