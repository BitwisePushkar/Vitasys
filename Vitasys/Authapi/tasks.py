...
def send_otp_email_task(email, otp, email_type):
    subject_map = {
        'verification': ' Verify Your Vitasys Account - OTP Code',
        'reset': ' Password Reset Request - OTP Code',
        'resend': ' New Verification Code - Vitasys'
    }
    
    message_map = {
        'verification': {
            'title': 'Email Verification',
            'intro': 'Thank you for registering with Vitasys Healthcare!',
    ...
    subject = subject_map.get(email_type, ' Your OTP Code - Vitasys')
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div class="warning">
                    ...
                    <p>• Vitasys will never ask for your OTP via phone or email</p>
                </div>
                ...
                <div class="security-note">
                    ...
                    <ul>
                        ...
                        <li>Never share your OTP with anyone, including Vitasys staff</li>
                        <li>Always verify you're on the official Vitasys website</li>
                    </ul>
                </div>
            ...
            <div class="footer">
                <p><strong>Vitasys Healthcare</strong></p>
                <p>&copy; 2024 Vitasys. All rights reserved.</p>
    ...
    • Vitasys will NEVER ask for your OTP
    
    🔒 SECURITY TIPS:
    • Didn't request this? Ignore this email and secure your account
    • Never share OTP with anyone, including Vitasys staff
    • Always verify you're on the official Vitasys website
    ...
    Best regards,
    Vitasys Healthcare Team
    
    ---
    © 2024 Vitasys. All rights reserved.
