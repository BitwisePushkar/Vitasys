...
class ChatRoomViewSet(viewsets.ViewSet):
    ...
    def send_message(self, request, pk):
        ...
        if chat_room.appointment and chat_room.appointment.status != 'confirmed':
            return Response({"error": "This chat has ended as the appointment is no longer confirmed"}, status=403)
