...
urlpatterns = [
    ...
    path('nurse-profile/',views.NurseDetailsView.as_view(),name='complete_nurse_profile'),
    path('pharmacist-profile/',views.PharmacistDetailsView.as_view(),name='complete_pharmacist_profile'),
